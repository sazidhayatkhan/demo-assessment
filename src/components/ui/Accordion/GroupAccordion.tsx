      ...
      {data.map((item, index) => (
        ...
        >
          ...
          >
            ...
            {openIndex === index ? <p>up</p> : <p>down</p>}
          </button>
          <div
