  ...
  return (
    <div className="w-full md:max-w-[330px] lg:max-w-[390px] order-2 absolute right-9 md:top-[55px] md:absolute">
      <div className="bg-white border border-slate-300 p-1">
        ...
        <div className="md:sticky md:top-[112px] mt-4">
          <div className="p-4">
            ...
            {/* Checklist */}
            <p className="mb-4 text-xl font-semibold mt-8">
              এই কোর্সে যা থাকছে
            </p>
      ...
      <div className="mt-4 flex justify-between items-center">
        ...
        <button className="cursor-pointer text-green font-semibold underline text-xs flex justify-center items-center"><span className="text-base"><IoIosCall/></span>ফোন করুন (16910)</button>
      </div>
    </div>
  );
};
