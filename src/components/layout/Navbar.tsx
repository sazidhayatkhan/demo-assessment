...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-20 bg-white px-0 md:px-7 py-4 w-full border-b border-slate-300">
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 md:px-7">
        ...
        <div className="hidden md:block relative flex-1 min-w-[180px] max-w-[320px] w-full me-5">
        ...
        {/* Nav Links */}
        <div className="hidden md:flex gap-6 items-center md:flex-wrap flex-nowrap text-sm text-gray-600 whitespace-nowrap">
          {data.map((item, idx) => {
            return (
              <button
                key={idx}
        ...
        {/* Phone & Login Buttons */}
        <button className="hidden md:flex items-center text-green ms-2">
        ...
        <div className="flex md:hidden justify-end items-center gap-3">
          ...
          <button className="text-nowrap bg-green text-white text-xs px-[10px] py-[8px] rounded">
          লগ-ইন
        </button>
        </div>
        <button className="hidden md:block text-nowrap bg-green text-white text-sm px-3 py-[4px] rounded ms-2">
          লগ-ইন
        </button>
      </div>
